...
export const EDH_temp = pgTable("EDH_tmp", { /* พักข้อมูลส่วนหัว (Header) จากไฟล์ TXT/TAB ชั่วคราว */
  ...
  Oder_Qty: varchar("Oder_Qty", { length: 10 }),
  Order_Amount: varchar("Order_Amount", { length: 10 }),
Discount_Amount: varchar("Discount_Amount", { length: 10 }),
  Tax_Amount: varchar("Tax_Amount", { length: 10 }),
  ...
  Generate_Date: varchar("Generate_Date", { length: 10 }),
  Process_Date: varchar("Process_Date", { length: 10 }),
...
export const EDL_temp = pgTable("EDL_tmp", { /* พักข้อมูลรายการสินค้า (Detail) จากไฟล์ TXT/TAB ชั่วคราว */
  ...
  Unit_Price: varchar("Unit_Price", { length: 10 }),
  Order_Qty: varchar("Order_Qty", { length: 10 }),
  Net_Amount: varchar("Net_Amount", { length: 10 }),
  ...
  Discount_Amount_Unit: numeric("Discount_Amount_Unit", { precision: 12, scale: 2 }),
